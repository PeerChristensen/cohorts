...
## Creating a wide month level cohort table
...
We can then turn this into a wide cohort table where each customer ID is tracked from the first invoice month until the last month in the period.
...
## Creating a wide day level cohort table
...
gamelaunch_long %>%
  ...
  ggplot(aes(x = time, y = reorder(cohort, desc(cohort)))) +
